...
public class ChunkProviderBacon implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderBacon(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int l1 = 0; l1 < 8; ++l1)
                    {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2)
                        {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2)
                            {
                                if ((d16 += d15) > 0.0D)
                                {
                                    par3ArrayOfByte[j2 += short1] = (byte)BaconBlocks.darkstone.blockID;
                                }
                                else if (k1 * 8 + l1 < b2)
                                {
            ...
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == BaconBlocks.darkstone.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (byte)BaconBlocks.darkstone.blockID;
                                }
                            ...
                            else if (j1 > 0)
                            {
                                ...
                                if (j1 == 0 && b2 == BaconBlocks.darkstone.blockID)
                                {
