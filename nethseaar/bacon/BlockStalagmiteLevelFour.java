...
public class BlockStalagmiteLevelFour extends Block {

	@SideOnly(Side.CLIENT)
    private Icon stalagmiteTop;
	
        public BlockStalagmiteLevelFour(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
    	...
    	{
    		if(par1World.getBlockId(xPos, yPos - 1, zPos) == this.blockID || par1World.getBlockId(xPos, yPos - 1, zPos) == BaconBlocks.stalagmiteLevelFourBase.blockID){
    			return;
    		}
    		else if(par1World.getBlockId(xPos, yPos - 1, zPos) == BaconBlocks.stalagmiteLevelThree.blockID || par1World.getBlockId(xPos, yPos - 1, zPos) == BaconBlocks.stalagmiteLevelThreeBase.blockID){
    			return;}
    			...
    			if (l < 3)
    			{
    				...
    				if (i1 == 15)
    				{
    					if (par5Random.nextInt(3) == 1){
    						...
    						if (par5Random.nextInt(3) == 1){
    							par1World.setBlock(par2, par3, par4, BaconBlocks.stalagmiteLevelThree.blockID);
    						}
    					}
    					else{
