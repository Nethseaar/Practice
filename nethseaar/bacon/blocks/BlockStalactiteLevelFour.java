...
public class BlockStalactiteLevelFour extends Block {

	@SideOnly(Side.CLIENT)
    private Icon stalactiteTop;
	
        public BlockStalactiteLevelFour(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
    	...
    	{
    		if(par1World.getBlockId(xPos, yPos + 1, zPos) == this.blockID || par1World.getBlockId(xPos, yPos + 1, zPos) == BaconBlocks.stalactiteLevelFourBase.blockID){
    			return;
    		}
    		else if(par1World.getBlockId(xPos, yPos + 1, zPos) == BaconBlocks.stalactiteLevelThree.blockID || par1World.getBlockId(xPos, yPos + 1, zPos) == BaconBlocks.stalactiteLevelThreeBase.blockID){
    			return;}
    			...
    			if (l < 3)
    			{
    				...
    				if (i1 == 15)
    				{
    					if (par5Random.nextInt(3) == 1){
    						par1World.setBlock(par2, par3 - 1, par4, BaconBlocks.stalactiteLevelFour.blockID);
    						if (par5Random.nextInt(3) == 1){
    							par1World.setBlock(par2, par3, par4, BaconBlocks.stalactiteLevelThree.blockID);
    						}
    					}
    					else{
    						par1World.setBlock(par2, par3 - 1, par4, BaconBlocks.stalactiteLevelFive.blockID);
    					}
