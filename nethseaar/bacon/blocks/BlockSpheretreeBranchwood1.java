...
public class BlockSpheretreeBranchwood1 extends Block {
    ...
    private Icon spheretree1Bottom;
        ...
        public BlockSpheretreeBranchwood1(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
        ...
        {
            this.blockIcon = par1IconRegister.registerIcon("spheretreeBranchwood00");
            this.spheretreeSide1 = par1IconRegister.registerIcon("spheretreeBranchwood01");
            this.spheretreeSide2 = par1IconRegister.registerIcon("spheretreeBranchwood02");
            this.spheretreeSide3 = par1IconRegister.registerIcon("spheretreeBranchwood03");
