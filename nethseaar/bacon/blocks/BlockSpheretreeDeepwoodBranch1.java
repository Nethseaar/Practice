...
public class BlockSpheretreeDeepwoodBranch1 extends Block {
    ...
    private Icon spheretree1Bottom;
        ...
        public BlockSpheretreeDeepwoodBranch1(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
        ...
        {
            this.blockIcon = par1IconRegister.registerIcon("spheretreeDeepwoodBranch0");
            this.spheretreeSide1 = par1IconRegister.registerIcon("spheretreeDeepwoodBranch1");
