...
public class BlockSpheretreeDeepwoodCorner1 extends Block {
    ...
    private Icon spheretree1Bottom;
        ...
        public BlockSpheretreeDeepwoodCorner1(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
        ...
        {
        	  this.blockIcon = par1IconRegister.registerIcon("spheretreeDeepwoodCorner00");
              this.spheretreeSide1 = par1IconRegister.registerIcon("spheretreeDeepwoodCorner01");
              this.spheretreeSide2 = par1IconRegister.registerIcon("spheretreeDeepwoodCorner02");
              this.spheretreeSide3 = par1IconRegister.registerIcon("spheretreeDeepwoodCorner03");
