...
public class BlockSpheretreeCorewood extends Block {
    ...
    private Icon spheretree1Bottom;
        ...
        public BlockSpheretreeCorewood(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
        ...
        {
            this.blockIcon = par1IconRegister.registerIcon("spheretreeBranchwood0");
            this.spheretreeSide1 = par1IconRegister.registerIcon("spheretreeBranchwood1");
            this.spheretreeSide2 = par1IconRegister.registerIcon("spheretreeBranchwood2");
            this.spheretreeSide3 = par1IconRegister.registerIcon("spheretreeBranchwood3");
