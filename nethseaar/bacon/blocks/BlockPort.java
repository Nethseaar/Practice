...
import nethseaar.bacon.dimension.TeleporterBacon;

public class BlockPort extends BlockPortal
{
 public BlockPort(int id, int texture)
 {
  super(id);
 ...
 public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
 {
  if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
  {
   if (par5Entity instanceof EntityPlayerMP)
   {
    ...
    if (par5Entity.dimension != Bacon.dimension)
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Bacon.dimension, new TeleporterBacon(thePlayer.mcServer.worldServerForDimension(Bacon.dimension)));
    }
    else
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterBacon(thePlayer.mcServer.worldServerForDimension(0)));
    }
   }
  }
 }
