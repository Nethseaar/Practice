...
public class BlockSpheretreeDeepwoodBranch extends Block {
    ...
    private Icon spheretree1Bottom;
        ...
        public BlockSpheretreeDeepwoodBranch(int id, Material material) {
                super(id, material);
            	setHardness(3.0F);
        		setResistance(5.0F);
        ...
        {
            this.blockIcon = par1IconRegister.registerIcon("spheretreeDeepwoodBranch00");
            this.spheretreeSide1 = par1IconRegister.registerIcon("spheretreeDeepwoodBranch00");
            this.spheretreeSide2 = par1IconRegister.registerIcon("spheretreeDeepwoodBranch00");
            this.spheretreeSide3 = par1IconRegister.registerIcon("spheretreeDeepwoodBranch00");
