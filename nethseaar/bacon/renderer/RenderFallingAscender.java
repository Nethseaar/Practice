...
public class RenderFallingAscender extends Render
{
    private RenderBlocks sandRenderBlocks = new RenderBlocks();

    public RenderFallingAscender()
    {
     ...
     */
    public void doRenderFallingAscender(EntityFallingAscender par1EntityFallingSand, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.doRenderFallingAscender((EntityFallingAscender)par1Entity, par2, par4, par6, par8, par9);
    }
}