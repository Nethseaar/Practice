...
public class GuiStoneCrafting extends GuiContainer
{
    public GuiStoneCrafting(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
